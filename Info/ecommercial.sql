...
CREATE TABLE public.logs (
    ...
    date date NOT NULL,
    audit character varying(50) NOT NULL
);
...
COPY public.logs (id, detail, date, audit) FROM stdin;
\.
...
5	1234	2	1	Deneme	10.00	20	15.00	28	Day	Açıklama	{Özellik:1}	Cargoşirket	6
13	12345	2	1	Deneme	10.00	20	15.00	28	Day	Açıklama	{Özellik:1}	Cargoşirket	6
\.
...
ALTER TABLE ONLY public.user_roles
    ADD CONSTRAINT fk_user_role_role FOREIGN KEY (role_id) REFERENCES public.roles(id) ON UPDATE CASCADE;
...
ALTER TABLE ONLY public.user_roles
    ADD CONSTRAINT fk_user_role_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE;
